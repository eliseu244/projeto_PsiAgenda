            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-dar/60 font-medium hidden sm:block">
                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <Link to="/login">
                        <button className="bg-gradient-to-r bg-dark text-white px-3 py-2 md:px-4 rounded-lg font-medium hover:shadow-lg transition-all duration-300 text-sm md:text-base">
